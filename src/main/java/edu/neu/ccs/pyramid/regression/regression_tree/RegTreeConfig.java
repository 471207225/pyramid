...
public class RegTreeConfig {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("RegTreeConfig{");
        sb.append("numSplitIntervals=").append(numSplitIntervals);
        sb.append(", maxNumLeaves=").append(maxNumLeaves);
        sb.append(", minDataPerLeaf=").append(minDataPerLeaf);
        sb.append(", randomLevel=").append(randomLevel);
        sb.append('}');
        return sb.toString();
    }
}
